...
ALTER TABLE [dbo].[Municipalities] ADD
CONSTRAINT [FK_dbo.Municipalities_dbo.Departments_DepartmentId] FOREIGN KEY ([DepartmentId]) REFERENCES [dbo].[Departments] ([DepartmentId])
GO
